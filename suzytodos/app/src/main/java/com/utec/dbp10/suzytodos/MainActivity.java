...
public class MainActivity extends AppCompatActivity {
    ...
    public void abrirtodos(View veiw) {
        ...
        if(username.equals("") || password.equals("")) {
            Toast.makeText(getApplicationContext(), "Please fill in all the login fields", Toast.LENGTH_LONG).show();
        }
        else {
            lusername.setText("");
            lpassword.setText("");
    ...
    public void signup(View veiw) {
        ...
        if(username.equals("") || password.equals("") || email.equals("")) {
            Toast.makeText(getApplicationContext(), "Please fill in all the signup fields", Toast.LENGTH_LONG).show();
        }
        else {
            rusername.setText("");
            rpassword.setText("");
